...
export async function GET(req: NextRequest) {
  try {
    ...
    const response = await fetch(EXTERNAL_ROUTES.PEOPLE.BASE, {
      method: 'GET',
      headers: {
    ...
    try {
      ...
      data = { message: responseText || 'Error al obtener personas' };
    }
...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      ...
      // Si no es JSON, devolver el texto como mensaje
      data = { message: responseText || 'Person created successfully' };
    }
