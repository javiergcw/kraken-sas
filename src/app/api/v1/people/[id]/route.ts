...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(EXTERNAL_ROUTES.PEOPLE.BY_ID(id), {
      method: 'GET',
      headers: {
    ...
    try {
      ...
      data = { message: responseText || 'Error al obtener persona' };
    }
...
export async function PUT(
  ...
  try {
    ...
    try {
      ...
      // Si no es JSON, devolver el texto como mensaje
      data = { message: responseText || 'Person updated successfully' };
    }
