...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(EXTERNAL_ROUTES.MARINAS.BY_ID(id), {
      method: 'GET',
      headers: {
    ...
    try {
      ...
      data = { message: responseText || 'Error al obtener marina' };
    }
...
export async function PUT(
  ...
  try {
    ...
    try {
      ...
      // Si no es JSON, devolver el texto como mensaje
      data = { message: responseText || 'Marina updated successfully' };
    }
