...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(EXTERNAL_ROUTES.OPERATIONS.BY_ID(id), {
      method: 'GET',
      headers: {
    ...
    try {
      ...
      data = { message: responseText || 'Error al obtener operación' };
    }
...
export async function PUT(
  ...
  try {
    ...
    try {
      ...
      // Si no es JSON, devolver el texto como mensaje
      data = { message: responseText || 'Daily operation updated successfully' };
    }
