...
export async function GET(req: NextRequest) {
  try {
    ...
    const response = await fetch(EXTERNAL_ROUTES.ZONES.BASE, {
      method: 'GET',
      headers: {
    ...
    try {
      ...
      data = { message: responseText || 'Error al obtener zonas' };
    }
...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      ...
      data = { message: responseText || 'Zone created successfully' };
    }
