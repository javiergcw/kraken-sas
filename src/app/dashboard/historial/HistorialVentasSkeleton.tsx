...
const HistorialVentasSkeleton: React.FC = () => {
  return (
    <Box sx={{ px: { xs: 2, sm: 3, md: 6 }, py: 2, backgroundColor: 'white', height: 'calc(100vh - 64px)', overflow: 'hidden' }}>
        ...
        <Box sx={{ 
          ...
          <Box sx={{ display: 'flex', gap: { xs: 1, sm: 1.5 }, width: { xs: '100%', sm: 'auto' } }}>
            <Skeleton 
              variant="rounded" 
              height={32} 
              sx={{ borderRadius: 1, flex: { xs: 1, sm: '0 0 auto' }, width: { xs: '100%', sm: 120 } }}
            />
          </Box>
        </Box>
      ...
      <Box sx={{ 
        ...
        <Skeleton 
          variant="text" 
          height={20} 
          sx={{ order: { xs: 2, sm: 1 }, width: { xs: '100%', sm: 200 } }}
        />
        <Box sx={{ 
          display: 'flex', 
          gap: 0.5, 
...
export default HistorialVentasSkeleton;
